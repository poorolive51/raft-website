...
style: |
  ...
  h2 { font-size: 28px; font-weight: 600; margin-bottom: 0.8em; }
  h2::after { content: ''; display: block; margin-top: 12px; width: 60px; height: 4px; background: var(--color-secondary); border-radius: 2px; }
  ...
  .divider-slide h1 { color: white; font-size: 48px; border-bottom: none; margin-bottom: 0; line-height: 1.2; }
  ...
  .impact-heading { font-family: 'Outfit', sans-serif; font-size: 18px; font-weight: 600; color: var(--color-primary); text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 10px; border-bottom: 2px solid var(--color-secondary); padding-bottom: 5px; display: inline-block; white-space: nowrap; }
...
<!-- _class: title-slide -->
![bg right:60%](images/masonry_v4_opt1.jpg)
...
<!-- _class: title-slide -->
![bg right:60%](images/masonry_v4_opt2.jpg)
...
<!-- _class: title-slide -->
![bg right:60%](images/masonry_v4_opt3.jpg)
...
<!-- _class: title-slide -->
![bg right:60%](images/masonry_v4_opt4.jpg)
